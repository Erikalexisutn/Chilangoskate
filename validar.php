...
$query = $conn -> prepare("SELECT * FROM usuario where correo_u= :correo and contra_u= :contra");
...
if ($usuario) {
    ...
    header("Location:compralogin.php");
    ...
    echo "<a href='iniciar.html'>    <a href='iniciar.html'><button class='btn btn-primary text-uppercase' type='button'> REINTENTAR </button></a> </a>";

    echo "<a href='iniciar.html'>    <a href='registro.html'><button class='btn btn-danger' type='button'> REGISTRASE </button></a> <br><br><br>";
